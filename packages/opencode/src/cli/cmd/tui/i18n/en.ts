export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using PentesterCode, you agree to our ",
  ...
  "tui.tips.mcp_oauth": "PentesterCode auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "tui.tips.formatter": "PentesterCode auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "PentesterCode uses LSP servers for intelligent code analysis",
  ...
  "tui.tips.plugin_protect": "Create a plugin to prevent PentesterCode from reading sensitive files",
  ...
  "tui.tips.serve": "Run {highlight}mimo serve{/highlight} for headless API access to PentesterCode",
  ...
  "tui.skill.mimocode.description": "Self-documentation for PentesterCode features, config, and commands",
  ...
  "tui.skill.drive-mimo.description": "Programmatically drive another PentesterCode process — headless JSON events or interactive TUI via tmux",
  ...
  "tui.toast.update_available.success": "Successfully updated to PentesterCode v{{version}}. Please restart the application.",
  ...
  "trust.capabilities": "PentesterCode will be able to read, edit, and execute files here.",
  ...
  "skip_permissions.body":
    "You started with --dangerously-skip-permissions. PentesterCode will read, edit, and execute files and run shell commands WITHOUT asking for approval. Only rules you have explicitly denied in config are still enforced. You are solely responsible for anything it does.",
