...
describe("ProviderTransform.variants", () => {
  ...
  describe("@ai-sdk/github-copilot", () => {
    ...
    test("gpt-5.6-sol includes xhigh and max", () => {
      const model = createMockModel({
        id: "gpt-5.6-sol",
  ...
  describe("@ai-sdk/openai", () => {
    ...
    test("gpt-5.5 includes none and xhigh", () => {
      const model = createMockModel({
        id: "gpt-5.5",
        providerID: "openai",
        api: {
    ...
    test("gpt-5.6-sol includes max effort and no minimal", () => {
      const model = createMockModel({
        id: "gpt-5.6-sol",
        providerID: "openai",
        api: {
    ...
    test("gpt-5.6-terra and gpt-5.6-luna include max effort", () => {
      for (const id of ["gpt-5.6-terra", "gpt-5.6-luna", "gpt-5.6"] as const) {
        const model = createMockModel({
          id,
          providerID: "openai",
          api: {
